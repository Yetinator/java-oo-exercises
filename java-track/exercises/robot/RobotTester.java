...
public class RobotTester {
	...
	public void testMove() {
		Robot box = new Robot("boxey90", 1, 1, 90, 5);
		...
		//180
		Robot box2 = new Robot("boxey180", 1, 1, 180, 5);
		...
		//270
		Robot box3 = new Robot("boxey270", 1, 1, 270, 5);
		...
		//0
		Robot box4 = new Robot("boxey0", 1, 1, 0, 5);
		...
		//360
		Robot box5 = new Robot("boxey360", 1, 1, 360, 5);
	...
	public void testRotate() {
		Robot box = new Robot("box Rotate", 1, 1, 0, 5);
	...
	public void testDistance() {
		Robot box1 = new Robot("box one", 1 ,1, 0, 5);
		Robot box2 = new Robot("box two", 6, 6, 0, 5);
